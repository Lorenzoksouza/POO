...
public class Executavel {
	...
	public static void main(String[] args) {
		...
		Endereco enderecoTavares = new Endereco("Rua das bromélias", 305, "Santa Mônica", "Florianópois", "SC");
		Endereco enderecoGuilherme = new Endereco("Rua dos rubis", 15, "Barreiros", "São Jóse", "SC");
		Endereco enderecoLuana = new Endereco("Rua das ametistas", 5522, "Coqueiros", "Florianópois", "SC");
